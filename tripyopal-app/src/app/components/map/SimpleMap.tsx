...
export default function SimpleMap() {
  ...
  return (
    <div className="rounded-3xl border border-forest-700 bg-forest-900 p-6 text-slate-100 shadow-sm">
      <h3 className="text-center font-[family-name:var(--font-brand)] text-lg font-semibold">
        <strong>{sectionText("map", "title", "Mapa Interactivo")}</strong>
      </h3>
      <p className="mt-3 text-sm text-slate-400">{sectionText("map", "description", "Explora la ciudad con un mapa en vivo vinculado a Google Maps.")}</p>
      ...
      <div className="mt-4 flex justify-center">
        ...
        >
          {sectionText("map", "buttonText", "Abrir en Maps")}
